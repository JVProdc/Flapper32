...
// Motors IDs define
#define MOTOR_BLDC1  0
#define MOTOR_BLDC2  1
#define SERVO1       2
#define SERVO2       3

// GPIO Pins for BLDC Motors and Servos
#define MOTOR_BLDC1_GPIO  CONFIG_MOTOR01_PIN
#define MOTOR_BLDC2_GPIO  CONFIG_MOTOR02_PIN
#define SERVO1_GPIO       CONFIG_MOTOR03_PIN
#define SERVO2_GPIO       CONFIG_MOTOR04_PIN

#define PWM_CHANNEL_BLDC1  0
#define PWM_CHANNEL_BLDC2  1
#define PWM_CHANNEL_SERVO1 2
#define PWM_CHANNEL_SERVO2 3   
